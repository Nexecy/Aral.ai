      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
            Aral.ai turns your syllabus, PDFs, slides, and textbooks into structured
            smart notes, automated active recall flashcards, diagnostic mock exams, and an instant
            grounded AI tutor.
          </p>
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3.5">
            ...
            <a
              href="#features"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-surface-container-low hover:bg-surface-container border border-border text-foreground text-sm font-semibold transition-colors"
            >
